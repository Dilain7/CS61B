...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
                              int targetYear) {
        return presentValue*(java.lang.Math.pow(1+rate/100,CompoundInterest.numYears(targetYear)));
    }
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        return futureValue(presentValue, rate, targetYear)*(java.lang.Math.pow(1-inflationRate/100, CompoundInterest.numYears(targetYear)));
    }
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        double yrs = CompoundInterest.numYears(targetYear);
        double val = perYear;
        while(yrs>0) {
            yrs -= 1;
            val *= (1+rate/100);
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        return totalSavings(perYear, targetYear, rate)*java.lang.Math.pow((1-inflationRate/100), numYears(targetYear));
    ...
    static void printDollarFV(int targetYear, double returnRate,
                              double inflationRate) {
        double nominalDollarValue = CompoundInterest.futureValue(1, RETURN_RATE, targetYear); // replace 0 with your code
        double realDollarValue = CompoundInterest.futureValueReal(1, RETURN_RATE, targetYear, INFLATION_RATE);    // replace 0 with your code
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double nominalSavings = CompoundInterest.totalSavings(PER_YEAR, TARGET_YEAR,returnRate); // replace 0 with your code
        double realSavings = CompoundInterest.totalSavingsReal(PER_YEAR, TARGET_YEAR, returnRate, inflationRate);    // replace 0 with your code
        // Do not change anything in this method below this line
